"""M9-B: reproducible dev50 manifest selection.
...
from evaluation.rca.adapter import PublicCase, load_public_cases
from evaluation.rca.leakage import load_history_instance_ids, validate_leakage
from evaluation.rca.manifest import ManifestCase, RcaManifest, load_manifest

SELECTOR_NAME = "evaluation.rca.select_manifest"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="python -m evaluation.rca.select_manifest",
        description="Reproducible dev50 manifest selection (M9-B)",
    )
    parser.add_argument(
        "--data-root",
        type=Path,
