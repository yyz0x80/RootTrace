...
class ModelConfigManager:
    ...
    DEFAULT_CONFIG_PATH = Path.home() / ".roottrace" / "models.json"
    FALLBACK_CONFIG_PATH = Path(".roottrace") / "models.json"
    ...
    def _find_config_file(self) -> Path | None:
        ...
        2. ~/.roottrace/models.json
        3. .roottrace/models.json (project local)
        """
    ...
    def resolve_with_env_fallback(
        ...
        # Fall back to environment variables when no named configuration exists.
        if provider_type == "openai":
            ...
            base_url = os.getenv("ROOTTRACE_BASE_URL") or os.getenv("OPENAI_BASE_URL")
            model_id = model_name or os.getenv("ROOTTRACE_MODEL") or "gpt-4o"
            ...
            model_id = model_name or os.getenv("ROOTTRACE_MODEL") or "claude-sonnet-4-20250514"
