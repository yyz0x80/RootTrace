"""Deterministic baseline variant tests (M9-C)."""

from __future__ import annotations

import json

from test_rca_eval_runner import _args, _setup_data, run_from_args

from evaluation.rca.baseline import DeterministicBaselineClient
from evaluation.rca.metrics import CaseResult
from patchpilot.rca.schema import IncidentInput, Provenance
