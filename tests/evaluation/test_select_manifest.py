"""Reproducible dev50 manifest selector tests."""
...
import pytest
from fixtures import public_record, write_json, write_jsonl

from evaluation.adapter import case_from_public_record, load_public_cases
from evaluation.manifest import RcaManifest, load_manifest
from evaluation.select_manifest import (
    allocate_quotas,
...
def test_cli_writes_dev50_and_report(tmp_path) -> None:
    ...
    assert report["selector"]["name"] == "evaluation.select_manifest"
