"""Tests for the ``patchpilot rca`` CLI and final report rendering."""
...
from patchpilot.rca.schema import PlanBudgets
...
def test_run_rca_command_with_scripted_providers(
    ...
    factory = _scripted_factory()
    monkeypatch.setattr(
        "patchpilot.rca.cli.create_provider_from_config",
