"""Disposable workspace and local repo cache resolution tests."""
...
import pytest
from rca_eval_fixtures import build_source_repo, make_bare_mirror, make_worktree_mirror

from evaluation.rca.manifest import ManifestCase
