"""Execution tracing for PatchPilot workflow.
...
including tool calls, model interactions, file modifications, and verification
results.
...
class TraceEvent(BaseModel):
    ...
    Attributes:
        ...
        workflow_stage: Current workflow stage (e.g., "CODING", "VERIFY").
